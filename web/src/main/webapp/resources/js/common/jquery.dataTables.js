...
(function( factory ) {
	...
	if ( typeof define === 'function' && define.amd ) {
		...
		define( 'datatables', ['common'], factory );
	}
...
(/** @lends <global> */function( $ ) {
	...
	function _fnAjaxUpdateDraw ( settings, json )
	{
		...
		settings._iRecordsTotal   = !!recordsTotal ? parseInt(recordsTotal, 10) : 0;
		settings._iRecordsDisplay = !!rocordsFiltered ? parseInt(rocordsFiltered, 10) : 0;
		...
		"fnDisplayEnd": function ()
		{
			...
			if ( features.bServerSide ) {
				return paginate === false || len === -1 ?
					start + records :
					Math.min( start + parseInt(len), this._iRecordsDisplay );
			}
			else {
